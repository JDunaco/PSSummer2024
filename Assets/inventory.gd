...
func _process(_delta):
	$GridContainer/Area1/Label.text = "Item1 : " + str(Game.items[0])
	$GridContainer/Area2/Label.text = "Item2 : " + str(Game.items[1])
	$GridContainer/Area3/Label.text = "Item3 : " + str(Game.items[2])
